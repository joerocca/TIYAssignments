...
@interface TimeCircuitsViewController ()
{
    ...
    NSInteger currentSpeed; //integers are not objects so no stars
}
...
- (void)viewDidLoad
{
    ...
    dateFormatter = [[NSDateFormatter alloc] init]; //creating a memory container for dateFormatter
...
- (void)updateSpeed
{
    ...
    if (currentSpeed < 88)
    {
        ...
        currentSpeed = currentSpeed + 1; //or currentSpeed++;
